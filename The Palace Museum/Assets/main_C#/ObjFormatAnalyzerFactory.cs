...
namespace Hont
{
    public static class ObjFormatAnalyzerFactory
    {
        public static GameObject AnalyzeToGameObject(string objFilePath)
        {
            ...
            //objFormatAnalyzer.Analyze(File.ReadAllText(objFilePath));//传入obj文件路径
            //objFormatAnalyzer.Analyze(File.ReadAllText("C:\\Users\\Administrator\\Desktop\\9186\\Garen.obj"));//传入obj文件路径
            objFormatAnalyzer.Analyze(objFilePath);
